...
func ExampleRouter_Add() {
	...
	r.Dump(func(u Digit, v []string, l int, e bool) {
		...
		fmt.Printf("%s [%s]", p.String(), u.Split())
		if len(v) != 0 {
			fmt.Printf(" = %v", v)
		}
		fmt.Println()
	...
	// │   │                       └── [0123456789]
	// │   │                           └── [0123456789]
	// │   │                               └── [0123456789*] = [5:"1(72[0-3|4-7|8|9],5[5|7].)......*"]
	// │   └── [7]
	// │       └── [2]
	// │           └── [0123456789]
	// │               └── [0123456789]
	...
	// │           │                   └── [0123456789]
	// │           │                       ├── [0123456789]
	// │           │                       │   ├── [0123456789] = [4:"7(49[5|9])......."]
	// │           │                       │   └── [0123456789*] = [2:"7(49[5|9]).......*"]
	// │           │                       └── [0123456789*] = [3:"7(49[5|9])......*"]
	// │           └── [5#]
	// │               └── [1]
	// │                   └── [2]
	// │                       └── [3]
	// │                           └── [0123456789*] = [6:"7495#123.*"]
	// └── [0123456789*] = [0:".*"]
}
